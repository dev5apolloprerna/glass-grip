...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .quote-meta td { height:8mm; vertical-align:middle; font-size:13.5px; }
        ...
        .party-tag-bar { height:12mm; line-height:9mm; padding:0 4.5mm; color:#fff; background:#285e10; font-size:12px; font-weight:800; letter-spacing:.3px; white-space:nowrap; overflow:hidden; }
        ...
        .terms-list td { height:3.8mm; font-size:12.8px; vertical-align:middle; }
...
<div class="quotation-page">
    ...
    <div class="bottom-layout"><div class="terms-cell"><div class="terms-title-row"><div class="terms-icon">i</div><div class="terms-heading">Terms &amp; Conditions:</div></div><table class="terms-list"><tr><td class="term-number">1.</td><td>This quotation is valid for 15 days from the date of issue.</td></tr><tr><td class="term-number">2.</td><td>Prices are subject to change without prior notice.</td></tr><tr><td class="term-number">3.</td><td>Payment Terms: <span class="term-line"></span></td></tr><tr><td class="term-number">4.</td><td>Delivery: <span class="term-line"></span></td></tr><tr><td class="term-number">5.</td><td>Subject to Ahmedabad Jurisdiction.</td></tr></table></div><div class="totals-cell"><table class="totals-table"><tr><td class="total-label">Sub Total</td><td class="rupee">₹</td><td class="total-value">{{ number_format($quotation->sub_total, 2) }}</td></tr>@if($quotation->discount_amount > 0)<tr><td class="total-label">Discount</td><td class="rupee">₹</td><td class="total-value">-{{ number_format($quotation->discount_amount, 2) }}</td></tr>@endif<tr><td class="total-label">CGST</td><td class="rupee">₹</td><td class="total-value">{{ number_format($quotation->cgst_amount, 2) }}</td></tr><tr><td class="total-label">SGST</td><td class="rupee">₹</td><td class="total-value">{{ number_format($quotation->sgst_amount, 2) }}</td></tr>@if($quotation->igst_amount > 0)<tr><td class="total-label">IGST</td><td class="rupee">₹</td><td class="total-value">{{ number_format($quotation->igst_amount, 2) }}</td></tr>@endif<tr><td class="total-label">Round Off</td><td class="rupee">₹</td><td class="total-value">{{ number_format($quotation->round_off, 2) }}</td></tr><tr class="grand-total"><td class="total-label grand-label">Grand Total</td><td class="rupee">₹</td><td class="total-value">{{ number_format($quotation->total_amount, 2) }}</td></tr></table></div><div class="bottom-clear"></div></div>
