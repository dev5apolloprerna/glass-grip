                    ...
                    <div class="card-body">
                        ...
                        <div class="totals-box">
                            ...
                            <div class="row">
                                ...
                                <span><input type="number" step="0.01" min="0" id="admin_charges" name="admin_charges" class="form-control" style="width:130px; text-align:right; display:inline-block; padding:5px 10px;" value="{{ old('admin_charges', $quotation->admin_charges) }}" placeholder="0"></span>
                            </div>
                            <div class="row">
                                <span>Material Handling Charges (&#8377;)</span>
                                <span><input type="number" step="0.01" min="0" id="material_handling_charges" name="material_handling_charges" class="form-control" style="width:130px; text-align:right; display:inline-block; padding:5px 10px;" value="{{ old('material_handling_charges', $quotation->material_handling_charges) }}" placeholder="0"></span>
                            </div>
